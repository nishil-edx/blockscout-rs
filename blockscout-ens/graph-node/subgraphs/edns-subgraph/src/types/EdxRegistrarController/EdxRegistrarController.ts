...
export class EdxRegistrarController__rentPriceResultPriceStruct extends ethereum.Tuple {
  get base(): BigInt {
...
export class EdxRegistrarController extends ethereum.SmartContract {
  static bind(address: Address): EdxRegistrarController {
    return new EdxRegistrarController("EdxRegistrarController", address);
  }
  ...
  rentPrice(
    name: string,
    duration: BigInt
  ): EdxRegistrarController__rentPriceResultPriceStruct {
    let result = super.call(
      "rentPrice",
    ...
    return changetype<EdxRegistrarController__rentPriceResultPriceStruct>(
      result[0].toTuple()
    );
  }
  ...
  try_rentPrice(
    name: string,
    duration: BigInt
  ): ethereum.CallResult<EdxRegistrarController__rentPriceResultPriceStruct> {
    let result = super.tryCall(
      "rentPrice",
      "rentPrice(string,uint256):((uint256,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<EdxRegistrarController__rentPriceResultPriceStruct>(
        value[0].toTuple()
      )
    );
  }
